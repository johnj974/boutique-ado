...
SECRET_KEY = '-+1p(3f__9gfm#k0d9tq^gdld&k$)x4+l#y5+8l+g*b-s*47t4'
...
# copied from django-allauth installation docs
...
# these variables added for all-auth functionality
